...
<div class="apic-cta" markdown>
**🛒 购买 · 开通 · 续费 —— APIC 卡网**

还没有授权,或需要续费?前往 **APIC 卡网** 在线下单,获取授权码后在面板中激活即可使用。卡网支持购买套餐、查询订单、提交工单。

[前往 APIC 卡网 →](https://buy.apic.gg){ .md-button .md-button--primary }
[安装部署指南](guide/install.md){ .md-button }
</div>
...
- **抗封锁加固**:出口 IP 轮换 + 按量限量、链路流量整形(填充 / 抖动 / 噪声)、接入层入站连接保护等进阶手段,应对流量阈值封 IP、长连接取证等。详见 [高级参数](guide/advanced.md)。
